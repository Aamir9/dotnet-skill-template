...
2. Edit every section to reflect what your project *actually* does. This
   file is only useful if it's true. Delete anything that doesn't apply,
   and add the conventions that are missing.
...
More skills loaded is not better results. Every skill an agent loads adds
